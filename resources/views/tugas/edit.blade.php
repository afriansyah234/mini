            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Edit Tugas</h4>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('tugas.update', $tugas->id) }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('judul_tugas') is-invalid @enderror" 
                                       id="judul_tugas" name="judul_tugas" value="{{ old('judul_tugas', $tugas->judul_tugas) }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                          id="deskripsi" name="deskripsi" rows="3">{{ old('deskripsi', $tugas->deskripsi) }}</textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('prioritas') is-invalid @enderror" id="prioritas" name="prioritas" required>
                                    ...
                                    <option value="krisis" {{ old('prioritas', $tugas->prioritas) == 'krisis' ? 'selected' : '' }}>krisis</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('status_tugas_id') is-invalid @enderror" id="status_tugas_id" name="status_tugas_id" required>
                                    ...
                                    @foreach($statuses as $status)
                                        <option value="{{ $status->id }}" {{ old('status_tugas_id', $tugas->status_tugas_id) == $status->id ? 'selected' : '' }}>
                                            {{ $status->nama_status }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            @endphp
                             <div class="mb-3">
                                ...
                                <input type="date" name="deadline" class="form-control" required min="{{ $besok }}" value="{{ old('deadline', $deadline) }}" 
                                readonly>
                                    <div class="invalid-feedback">
                                        Pilih deadline tugas
                                    </div>
                            </div>
