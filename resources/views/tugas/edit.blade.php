        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('tugas.update', $tugas->id) }}" method="POST" class="needs-validation"
                            novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('karyawan_id') is-invalid @enderror" id="karyawan_id"
                                    ...
                                    @foreach($karyawan as $k)
                                        <option value="{{ $k->id }}" {{ old('karyawan_id', $tugas->karyawan_id) == $k->id ? 'selected' : '' }}>
                                            {{ $k->nama_karyawan }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi"
                                    name="deskripsi" rows="3">{{ old('deskripsi', $tugas->deskripsi) }}</textarea>
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="deadline" class="form-control" required min="{{ $besok }}"
                                    value="{{ old('deadline', $deadline) }}" readonly>
                                <div class="invalid-feedback">
